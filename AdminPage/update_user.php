...
<div class="container-fluid my-5">
    <div class="tile px-2">
        ...
        <div class="row">
            ...
            $updateQuery = mysqli_query($Connection, "SELECT * FROM users WHERE id=$userId");
            if (!$updateQuery) {
              echo mysqli_error();
            }else{
                $fetchUser=mysqli_fetch_array($updateQuery);
                ?>
                                ...
                                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                                    <div class="form-group">
                                        <input name="user_firstname" type="text" class="form-control" id="userfirstname"
                                            value="<?php echo $fetchUser['name'];?>" placeholder="User Name">
                                        <span
                                ...
                                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                                    <div class="form-group">
                                        <input name="user_email" type="email" class="form-control" id="useremail"
                                            placeholder="Enter email" value="<?php echo $fetchUser['email'];?>">
                                        <span
                                            class="text-danger"><?php echo (isset($_SESSION["errors"])&&isset($_SESSION["errors"]["user_email"]))?$_SESSION["errors"]["user_email"]:""; ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                                    <div class="form-group">
                                        <input name="user_ph" type="text" class="form-control" id="userphoneno"
                                            placeholder="Phone Number" value="<?php echo $fetchUser['phone'];?>">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Date of Birth"
                                            ...
                                            value="<?php echo $fetchUser['dob'];?>" read_only="">
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-lg-6 col-md-6 col-12 col-sm-12">
                                    <select class="form-control" id="usergender" name="user_gender">
                                        ...
                                        <option value="<?php echo $fetchUser['id']; ?>"
                                            <?php echo $fetchUser['usergender']?"selected": ""; ?>>
                                            </option>
                                        ...
                                        <option value="<?php echo $fetchUser['usergender'];?>">
                                            <?php echo $fetchUser['usergender'];?></option>
