            ...
            <div class="col-lg-8">
                <div class="card user-card">
                    <div class="card-header">
                        <h2 class="text-dark text-center mb-0 p-0">User Register Form</h2>
                        ...
                        <form  action="tables/usertable" method="POST" enctype="multipart/form-data" id="personal_info_form">
                            ...
                            <div class="row mt-3 d-flex justify-content-center">
                                <div class="col-lg-6 col-md-6 col-12 col-sm-12 d-flex justify-content-center">
                                    <img src="Images/profile_icon.png" class="img-fluid imgplaceholder"
                                        onclick="triggerClick()" id="image_placeholder" />
                                    <div class="my-4" id="uploaduserimage" placeholder="upload image">
                                        <input onchange="DisplayImage(this)" name="image" class="form-control"
